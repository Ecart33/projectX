...
- (nonnull instancetype)initWithRouteOptions:(MBRouteOptions * _Nonnull)routeOptions legs:(NSArray<MBRouteLeg *> * _Nonnull)legs distance:(CLLocationDistance)distance expectedTravelTime:(NSTimeInterval)expectedTravelTime coordinates:(NSArray<NSValue *> * _Nullable)coordinates speechLocale:(NSLocale * _Nullable)speechLocale OBJC_DESIGNATED_INITIALIZER;
...
///
- (nonnull instancetype)initWithWaypoints:(NSArray<MBWaypoint *> * _Nonnull)waypoints profileIdentifier:(MBDirectionsProfileIdentifier _Nullable)profileIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithMatchOptions:(MBMatchOptions * _Nonnull)matchOptions;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
...
/// This is the structured representation of <code>text</code>.
...
/// Note that this property is irrelevant unless the <code>maneuverType</code> is
@property (nonatomic) CLLocationDegrees degrees;
/// :nodoc:
/// Initialize A <code>VisualInstructionBanner</code>.
