...
- (void)navigationViewControllerDidEndNavigation:(MBNavigationViewController * _Nonnull)navigationViewController cancelled:(BOOL)cancelled;
...
/// \param location The user’s current location.
///
- (NSString * _Nullable)navigationViewController:(MBNavigationViewController * _Nonnull)navigationViewController roadNameAt:(CLLocation * _Nonnull)location SWIFT_WARN_UNUSED_RESULT;
@end
